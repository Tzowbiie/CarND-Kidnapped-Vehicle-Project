...
The purpose of the project is to implement a particle filter able to localize a vehicle position and yaw within the values specified in a set of given parameters: `max_translation_error` and `max_yaw_error`.
...
| --- | 
| ![Your particle filter passed](https://github.com/Tzowbiie/CarND-Kidnapped-Vehicle-Project/blob/master/screenshots/particle_filter_fast.gif)|
